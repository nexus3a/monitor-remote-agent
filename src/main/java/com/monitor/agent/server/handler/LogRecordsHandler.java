                ...
                try {
                    ...
                    if (lock.tryLock()) {
                        ...
                        try {
                            ...
                            // выводим их в поток; в случае использования хранилища вида ParserByteListStorage вывод
                        ...
                        // здесь вывод в поток записей, если используется хранилище ParserByteListStorage:
                        // записи выводятся после накопления в хранилище, а не в процессе разбора
                        //
                        if (storage instanceof ParserByteListStorage && reader != null) {
